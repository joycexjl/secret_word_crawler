...
HOW_STYLES = {
    ...
    "track_src": ("gray40", "dotted"),
    "video_src": ("gray40", "dotted"),
    "audio_src": ("gray40", "dotted"),
    "sourcemap": ("darkorange", "dashed"),
    "http_link_header": ("blue", "dotted"),
    "json_value": ("darkgreen", "dotted"),
    "sw_register": ("red", "dashed"),
